<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fees.aspx.cs" Inherits="Student_fees" %>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									<li><a href="courses.aspx" class="active" >Current Courses</a></li>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<li><a href="result.aspx" class="active">Result</a></li>
								</ul>
							</li>
										...
										<table class="table table-hover table-center mb-0 datatable" >
											<thead>
												...
												<tbody>
													...
													<td class="text-nowrap">Course Enrollment</td>
													<td class="text-center">1123 $</td>
														 <td>
<div class="actions">
															<a href="underconstruction.aspx" class="btn btn-sm bg-success-light mr-2">Pay</a>
