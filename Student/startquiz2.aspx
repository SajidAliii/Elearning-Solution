<%@ Page Language="C#" AutoEventWireup="true" CodeFile="startquiz2.aspx.cs" Inherits="Student_startquiz2" %>
							...
							<div  class="card card-table">
								<div class="card-body">
								   	...
								   	<div class="form-group row">
											<label class="col-form-label col-md-2">Where am i from?</label>
											<div class="col-md-10">
												<div class="radio">
													<label>
														<input type="radio" name="radio"> Pakistan
													</label>
												</div>
												<div class="radio">
													<label>
														<input type="radio" name="radio"> India
													</label>
												</div>
												<div class="radio">
													<label>
														<input type="radio" name="radio"> Malaysia
													</label>
												</div>
												<div class="radio">
													<label>
