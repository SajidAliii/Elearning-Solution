<%@ Page Language="C#" AutoEventWireup="true" CodeFile="departments.aspx.cs" Inherits="Admin_departments" %>
...
<html lang="en">
    <head>
        ...
        <title>SJ International - Departments</title>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									<li><a href="departments.aspx" class="active">Department List</a></li>
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto text-right float-right ml-auto">
								<a href="add-department.aspx" class="btn btn-primary"><i class="fas fa-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-hover table-center mb-0 datatable">
											...
											<tbody>
                                                <asp:PlaceHolder ID="displaydepartment" runat="server"></asp:PlaceHolder>
											</tbody>
										</table>
									</div>
								</div>
