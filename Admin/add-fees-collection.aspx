<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-fees-collection.aspx.cs" Inherits="Admin_add_fees_collection" %>
...
<html lang="en">
    <head>
        ...
        <title>SJ International - Fees</title>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									<li><a href="fees-collections.aspx" class="active">Fees Collection</a></li>
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="fees-collections.aspx">Accounts</a></li>
