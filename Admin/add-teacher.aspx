<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-teacher.aspx.cs" Inherits="Admin_add_teacher" %>
...
<html lang="en">
    <head>
        ...
        <title>SJ International - Teachers</title>
						...
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<li><a href="add-teacher.aspx" class="active">Teacher Add</a></li>
								</ul>
							</li>
							<li class="submenu">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="teachers.aspx">Teachers</a></li>
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
                                                    ...
                                                    <asp:Label ID="error" runat="server" Text="Username Already Exists" Visible="false" CssClass="form-group" ForeColor="Red"></asp:Label>
													  <asp:TextBox ID="username" runat="server" CssClass="form-control"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="username" runat="server" ErrorMessage="Empty Field"></asp:RequiredFieldValidator>
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
											...
											<div class="col-12">
                                                <asp:Button ID="submit" runat="server" Text="Button" CssClass="btn btn-primary" OnClick="submit_Click" />
											</div>
										</div>
									</form>
								</div>
