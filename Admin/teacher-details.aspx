<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher-details.aspx.cs" Inherits="Admin_teacher_details" %>
...
<html lang="en">
    <head>
        ...
        <title>SJ International - Teacher Details</title>
								...
								<div class="col-md-12">
									<div class="about-info">
										...
										<div class="media mt-3">
											<img src="assets/img/jamal.jpg" class="mr-3" alt="...">
											<div class="media-body">
												<ul>
                                                    <li>
                                                        <span class="title-span">Full Name : </span>
                                                        <span class="info-span">Jamal Mohammed</span>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="info-span">0060 332233443</span>
                                                    </li>
                                                    <li>
                                                        <span class="title-span">Email : </span>
                                                        <span class="info-span">jamal@gmail.com</span>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="info-span">22 Apr 1975</span>
                                                    </li>
                                                </ul>
											</div>
										</div>
