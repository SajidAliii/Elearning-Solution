<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fees-collections.aspx.cs" Inherits="Admin_fees_collections" %>
...
<html lang="en">
    <head>
        ...
        <title>SJ International - Fees Collections</title>
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto text-right float-right ml-auto">
								...
								<a href="add-fees-collection.aspx" class="btn btn-primary"><i class="fas fa-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
