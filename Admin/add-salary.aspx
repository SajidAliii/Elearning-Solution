<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-salary.aspx.cs" Inherits="Admin_add_salary" %>
						...
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<li><a href="add-salary.aspx" class="active">Add Salary</a></li>
								</ul>
							</li>
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="salary.aspx">Accounts</a></li>
