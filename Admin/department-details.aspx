<%@ Page Language="C#" AutoEventWireup="true" CodeFile="department-details.aspx.cs" Inherits="Admin_department_details" %>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li >
								...
								<ul>
									<li><a href="students.aspx" class="active">Student List</a></li>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Bacherlors of Computer Science</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.aspx">Dashboard</a></li>
									<li class="breadcrumb-item active">BCSO</li>
								</ul>
							</div>
							<div class="col-auto text-right float-right ml-auto">
								<a href="#" class="btn btn-outline-primary mr-2"><i class="fas fa-download"></i> Download</a>
								<a href="add-student.aspx" class="btn btn-primary"><i class="fas fa-plus"></i></a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
									...
									<div class="table-responsive" >
										...
										<table class="table table-hover table-center mb-0 datatable" >
											<thead>
												...
												<tbody>
														<asp:PlaceHolder ID="displaystudents" runat="server"></asp:PlaceHolder>
												</tbody>
										</table>
									</div>
								</div></div></div>
