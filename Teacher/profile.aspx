...
<html lang="en">
    <head>
        ...
        <title>SJ International - Profile</title>
							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" alt="User Image" src="assets/img/profiles/sajid.jpg">

										</a>
									</div>
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">Jamal Abdul Kareem</h4>
										<h6 class="text-muted">Teacher</h6>
										<div class="user-Location">Doha Qatar</div>
									</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-9">Jamal Abdul Kareem</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Date of Birth</p>
														<p class="col-sm-9">2 Jun 1987</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
														<p class="col-sm-9">jamal@gmail.com</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Mobile</p>
														<p class="col-sm-9">573733664</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0">Address</p>
														<p class="col-sm-9 mb-0">Egypt </p>
													</div>
												</div>
											</div>
