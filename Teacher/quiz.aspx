<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quiz.aspx.cs" Inherits="Teacher_quiz" %>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									<li><a href="students.aspx" class="active">Student in Courses</a></li>
								</ul>
							</li>
							<li class="submenu active">
								<a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Quiz</span> <span class="menu-arrow"></span></a>
								<ul>
									<li><a href="quiz.aspx" class="active">Quiz Summary</a></li>
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Quiz summary</li>
								</ul>
							</div>
							...
							<form runat="server">
																	...
																	<a href="addquiz.aspx" class="btn btn-primary"><i class="fas fa-plus"></i></a>
											...
											<thead>
												...
												<tbody>
													...
													<td class="text-nowrap">Intelligent System</td>
																<td class="text-nowrap">Quiz 1 for Chapter 1</td>
												 <td>
<div class="actions">
															<a href="progress.aspx" class="btn btn-sm bg-success-light mr-2">See Progress</a>
