<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leave.aspx.cs" Inherits="Teacher_leave" %>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									<li><a href="leave.aspx" class="active">Leave Application</a></li>
						...
						<div class="col-sm-12">
							<div  class="card card-table">
								<div class="card-body">
									...
									<div> Click here to Download the Leave Application form
                                    <asp:Button ID="Button1" runat="server" Text="Download" OnClick="Button1_Click" /></div>

								
								</div>
								<div class="card-body">
										
									<div> Please upload the filled Leave application here
                                    <asp:FileUpload ID="FileUpload1" runat="server" />
										<asp:Button ID="Button2" runat="server" Text="Upload" OnClick="Button2_Click" /></div>
